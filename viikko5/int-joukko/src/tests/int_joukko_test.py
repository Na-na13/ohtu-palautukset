...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.kuuluuko_lukujonoon(11))
        joukko.poista_luku(11)
        self.assertFalse(joukko.kuuluuko_lukujonoon(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.kuuluuko_lukujonoon(10))
        self.assertFalse(self.joukko.kuuluuko_lukujonoon(5))
        self.assertTrue(self.joukko.kuuluuko_lukujonoon(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista_luku(3)
        self.assertFalse(self.joukko.kuuluuko_lukujonoon(3))
